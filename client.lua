...
local function addToState(state, value)
  return lib.callback.await('qbx_playerstates:server:addToState', false, state, value)
end
exports('AddToState', addToState)

local function clearState(state)
  return lib.callback.await('qbx_playerstates:server:clearState', false, state)
end
